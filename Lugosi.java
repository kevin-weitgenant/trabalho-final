...
public class Lugosi implements LugosiConstants {
  ...
  static final public Main Main() throws ParseException {
    ...
    while (true) {
      ...
      VarDecl(variavel_list);
    }
    jj_consume_token(FCHAVES);
      {if (true) return new Main(variavel_list);}
    // return new Main(variavel_list,comando_list);

    throw new Error("Missing return statement in function");
  }

  static final public void VarDecl(ArrayList<VarDecl> variavel_list) throws ParseException {
    String t,id;
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x1000,0xc040,};
   }
